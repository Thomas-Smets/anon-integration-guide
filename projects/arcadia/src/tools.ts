...
export const tools = [
    // ── Getters ──────────────────────────────────────────────────────
    {
        type: 'function',
        function: {
            name: 'getProtocolDescription',
            description: 'Get a plain-language explanation of how Arcadia Finance works, its core concepts, and typical user workflows.',
            strict: true,
            parameters: {
                type: 'object',
                properties: {},
    ...
    },
    {
        ...
        function: {
            ...
            parameters: {
                ...
                required: ['chainName', 'accountAddress', 'days'],
                additionalProperties: false,
            },
        },
    },
    ...
    // ── Asset manager intent encoding ───────────────────────────────
    {
        ...
        function: {
            ...
            parameters: {
                ...
                required: ['chainName', 'dexProtocol', 'enabled'],
                additionalProperties: false,
            },
        },
    },
    ...
    },
    {
        ...
        function: {
            ...
            parameters: {
                ...
                required: ['chainName', 'dexProtocol', 'sellTokens', 'buyToken', 'enabled'],
                additionalProperties: false,
            },
        },
    },
    {
        ...
        function: {
            ...
            parameters: {
                ...
                required: ['chainName', 'dexProtocol', 'feeRecipient', 'enabled'],
                additionalProperties: false,
            },
        },
    },
    {
        ...
        function: {
            ...
            parameters: {
                ...
                required: ['chainName', 'dexProtocol', 'sellTokens', 'buyToken', 'feeRecipient', 'enabled'],
                additionalProperties: false,
            },
        },
    },
    ...
    },
    {
        ...
        function: {
            ...
            parameters: {
                ...
                required: ['chainName', 'rewardRecipient', 'enabled'],
                additionalProperties: false,
            },
        },
    },
