export type DexProtocol = 'slipstream' | 'slipstream_v2' | 'staked_slipstream' | 'staked_slipstream_v2' | 'uniV3' | 'uniV4';
...
export function getAmAddress(category: 'rebalancers' | 'compounders' | 'yieldClaimers', dexProtocol: DexProtocol): string {
